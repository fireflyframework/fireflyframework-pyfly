...
class OrchestrationEvents(Protocol):
    ...
    async def on_completed(self, *, name: str, pattern: ExecutionPattern, correlation_id: str, success: bool, duration_ms: float) -> None: ...
    async def on_step_started(self, *, name: str, correlation_id: str, step_id: str) -> None: ...
    async def on_step_success(self, *, name: str, correlation_id: str, step_id: str, attempts: int, latency_ms: float) -> None: ...
    async def on_step_failed(self, *, name: str, correlation_id: str, step_id: str, error: BaseException, attempts: int, latency_ms: float) -> None: ...
    ...
    async def on_step_compensated(self, *, name: str, correlation_id: str, step_id: str, error: BaseException | None) -> None: ...
    async def on_phase_started(self, *, name: str, correlation_id: str, phase: TccPhase) -> None: ...
    async def on_phase_completed(self, *, name: str, correlation_id: str, phase: TccPhase, duration_ms: float) -> None: ...
    async def on_phase_failed(self, *, name: str, correlation_id: str, phase: TccPhase, error: BaseException) -> None: ...
    async def on_participant_started(self, *, name: str, correlation_id: str, phase: TccPhase, participant_id: str) -> None: ...
    async def on_participant_success(self, *, name: str, correlation_id: str, phase: TccPhase, participant_id: str) -> None: ...
    async def on_participant_failed(self, *, name: str, correlation_id: str, phase: TccPhase, participant_id: str, error: BaseException) -> None: ...
    ...
    async def on_child_workflow_started(self, *, parent: str, correlation_id: str, child_workflow: str, child_correlation: str) -> None: ...
    async def on_child_workflow_completed(self, *, parent: str, correlation_id: str, child_workflow: str, success: bool) -> None: ...
    async def on_continue_as_new(self, *, name: str, correlation_id: str, new_correlation_id: str) -> None: ...
    async def on_dead_lettered(self, *, name: str, correlation_id: str, step_id: str | None, error: BaseException) -> None: ...


class _BaseOrchestrationEvents:
    """No-op base class so concrete adapters only override what they care about."""

    async def on_start(self, **_: Any) -> None: ...
    async def on_completed(self, **_: Any) -> None: ...
    async def on_step_started(self, **_: Any) -> None: ...
    async def on_step_success(self, **_: Any) -> None: ...
    async def on_step_failed(self, **_: Any) -> None: ...
    async def on_step_skipped(self, **_: Any) -> None: ...
    async def on_compensation_started(self, **_: Any) -> None: ...
    async def on_step_compensated(self, **_: Any) -> None: ...
    async def on_phase_started(self, **_: Any) -> None: ...
    async def on_phase_completed(self, **_: Any) -> None: ...
    async def on_phase_failed(self, **_: Any) -> None: ...
    async def on_participant_started(self, **_: Any) -> None: ...
    async def on_participant_success(self, **_: Any) -> None: ...
    async def on_participant_failed(self, **_: Any) -> None: ...
    async def on_workflow_suspended(self, **_: Any) -> None: ...
    async def on_workflow_resumed(self, **_: Any) -> None: ...
    async def on_signal_delivered(self, **_: Any) -> None: ...
    async def on_timer_fired(self, **_: Any) -> None: ...
    async def on_child_workflow_started(self, **_: Any) -> None: ...
    async def on_child_workflow_completed(self, **_: Any) -> None: ...
    async def on_continue_as_new(self, **_: Any) -> None: ...
    async def on_dead_lettered(self, **_: Any) -> None: ...
...
class LoggerOrchestrationEvents(_BaseOrchestrationEvents):
    ...
    async def on_step_compensated(
        ...
        if error is None:
            ...
            _logger.error(
                "[%s] compensation for %s.%s FAILED: %s", correlation_id, name, step_id, error
            )
